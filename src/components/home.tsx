...
const Home = () => {
  ...
  />
              ...
              <p className="text-gray-400">
                ...
                services for artists worldwide based in Namibia. We are currently looking for Sponsors/ Investors to help us reach this goal and help Namibian Artist. Please Call 0812320168
              </p>
            </div>
